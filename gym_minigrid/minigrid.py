...
class Grid:
    ...
    def render_tile(
        ...
        if agent_dir is not None:
            ...
            # fill_coords(img, tri_fn, (0,255,255))#(255, 0, 0))
            if previous_record:
                fill_coords(img, tri_fn, (180, 180, 180)) # (200, 200, 200)) # ORANGE
            else:
                fill_coords(img, tri_fn, (0, 255, 255)) # (255, 0, 0)) # RED
        ...
        for j in range(0, self.height):
            for i in range(0, self.width):
                ...
                tile_img = Grid.render_tile(
                    ...
                    tile_size=tile_size,
                    previous_record=True if not agent_here and prev_pos_mask is not None and prev_pos_mask[i, j] != -1 else False
                )
